...
<div class='vcalendar'>
	<div class='vevent'>
		<h1 class='summary'><?php echo UNL_UCBCN_Frontend::dbStringToHtml($this->event->title); ?> <a class="permalink" href="<?php echo $this->url; ?>" title="Permanent link for this event">[permalink]</a></h1>
