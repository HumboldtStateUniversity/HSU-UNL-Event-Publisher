		...
		<tr<?php if ($oddrow) echo ' class="alt"'; ?>>
			...
			<td class="delete">
				...
				if ($event['usercandeleteevent']) {
					...
					echo '<a onclick="return confirm(\'Are you sure you wish to delete '.htmlentities($event['title']).'? \n\nYour event will not automatically be deleted from the main calendar. To request your event be removed from the main calendar, contact the calendar editor at calendar@humboldt.edu.\');" href="'.$delete_url.'">Delete</a></td>';
				} ?>
			</td>
		</tr>
	<?php
