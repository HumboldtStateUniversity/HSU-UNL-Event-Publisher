...
?>| Events</title>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="http://code.jquery.com/mobile/1.0/jquery.mobile-1.0.min.css" />
...
<?php } else {
    UNL_UCBCN::displayRegion($this->output);
		...
		<p class="standard-link">Switch to <a rel="external" href="<?php echo $this->output[0]->url; ?>?template=humboldt">standard 
events site</a></p>
		</div>
		</div>
