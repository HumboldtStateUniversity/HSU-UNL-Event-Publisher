...
<div id="wrap">
	...
	<div id="maincontent">
		...
		<div id="banner" class="clearfix">
			<div id="banner-wrap">
				<!--<h1 id="calname"><a class="maincal" href="<?php echo $this->uri; ?>"><span class="ir"><?php echo $this->calendar->name; ?></span></a></h1>-->
				<?php	
				     if ($this->calendar->id == '1']){ // Only show on main calendar                       
				     	...
				     	echo '<h1 id="calname"><a href="'.UNL_UCBN_Frontent::dbString($this->uri).'">'.UNL_UCBN_Frontend::dbString($this->calendar->name).' </a>';
				     }
				 }
				  ?>
<!--search form-->
