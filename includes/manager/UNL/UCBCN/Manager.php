		...
		break;
            ...
            case 'subscribe':
                ...
                $this->output[]   = '<p>Subscriptions allow you to automatically add events to your calendar which match a given set of criteria.
                                    This feature allows the College of Natural Resources and Sciences\'s Calendar to automatically add all events posted to the Environmental Resources Engineering calendar.</p>';
