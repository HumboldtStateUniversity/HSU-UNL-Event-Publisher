...
foreach ($this->events as $e) {
    ...
    $row = '<a rel="external" class="url" href="'.UNL_UCBCN_Frontend::dbStringToHtml($e->url).'"><div class="vevent';
    if ($oddrow) {
        $row .= ' alt';
    }
    $row .= '">';
    ...
    $row .=  '<div><h3 class="summary">'.UNL_UCBCN_Frontend::dbStringToHtml($e->event->title).'</h3></div>' .  '<div class="date">';
