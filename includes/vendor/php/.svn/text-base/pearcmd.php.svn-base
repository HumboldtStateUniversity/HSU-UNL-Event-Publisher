 ...
 * @nodep Gtk
 */
if ('/Users/bbieber/Documents/workspace/standalone/includes/vendor/php' != '@'.'include_path'.'@') {
    ini_set('include_path', '/Users/bbieber/Documents/workspace/standalone/includes/vendor/php');
    $raw = false;
} else {
