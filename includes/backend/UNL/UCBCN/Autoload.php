...
function UNL_UCBCN_Autoload($class)
{
...
if (function_exists('spl_autoload_register')) {
    if (!($_____t = spl_autoload_functions()) || !in_array('UNL_UCBCN_Autoload', spl_autoload_functions())) {
        spl_autoload_register('UNL_UCBCN_Autoload');
